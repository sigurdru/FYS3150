...
In order to make sure our algorithm runs correctly, we want to test it. Throughout all the simulations we are going to make sure both energy and spin is conserved. 
