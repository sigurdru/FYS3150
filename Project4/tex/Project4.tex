...
As mentioned above, we are going to use periodic boundary conditions. The easiest, but slow way of implementing this, is with if-tests. However we did it with a simple function (in c++) that takes (FORTELL HVORDAN DETTE FUNGERER HER)
\begin{lstlisting}
