...
\begin{abstract}
	Being able to accurately describe motion in space is important when doing ex. space exploration. In this report we study a wide array of problems connected to planetary orbits. This includes studying Forward Euler and Velocity Verlet as solvers for planetary orbits. We found Forward Euler to be faster, but Velocity Verlet to be more precise. We also study different forms of Newton's gravitational force, namely when we vary it from an inverse-square law, to inverse-cube. The results didn't seem to vary a lot, until we arrived at an inverse-cube term. Then we got quite different results, with larger numerical error. When studying the escape velocity of a planet in an gravitational potential, we got expected around 8.89AU/yr, and got 8.89AU/yr. Adding a relativistic term to Mercury's perihelion precession we also arrived close (got 43.26 arcseconds) to the expected value of 43 arcseconds. We also developed code for simulating systems of bodies interacting through the gravitational force. Using this we could simulate the three-body system of the Earth, Sun and Jupiter as well as a full simulation of the entire Solar System including Pluto and Jupiter's moon Europa. The motion of Jupiter with its real-world mass did not have a large effect on the motion of the Earth and the Sun other than a small oscillation in total energy of about 0.002 $M_\odot$ AU$^2$/yr$^2$. When running the simulation with the mass of Jupiter multiplied with 10 and 1 000 we got an unstable system where energy oscillated and the Earth was flung out of the system in the case of largest mass of Jupiter. When simulating the entire Solar System, we saw that all the objects moved in elliptical orbits. The energy oscillated by 0.002 $M_\odot$ AU$^2$/yr$^2$ but was conserved over time.
\end{abstract}
